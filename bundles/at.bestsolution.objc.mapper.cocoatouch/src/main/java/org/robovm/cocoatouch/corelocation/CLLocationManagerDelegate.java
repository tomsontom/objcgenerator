...
public interface CLLocationManagerDelegate extends NSObjectProtocol {
	...
	public void didPauseLocationUpdates(CLLocationManager locationManagerDidPauseLocationUpdates);
	public void didResumeLocationUpdates(CLLocationManager locationManagerDidResumeLocationUpdates);
	public void didUpdateHeading(CLLocationManager locationManager,CLHeading didUpdateHeading);
	public boolean shouldDisplayHeadingCalibration(CLLocationManager locationManagerShouldDisplayHeadingCalibration);
	...
	public static class Adapter extends NSObject implements CLLocationManagerDelegate {
		...
		@NotImplemented("locationManagerDidPauseLocationUpdates:") public void didPauseLocationUpdates(CLLocationManager locationManagerDidPauseLocationUpdates) { throw new UnsupportedOperationException(); }
		@NotImplemented("locationManagerDidResumeLocationUpdates:") public void didResumeLocationUpdates(CLLocationManager locationManagerDidResumeLocationUpdates) { throw new UnsupportedOperationException(); }
		...
		@NotImplemented("locationManagerShouldDisplayHeadingCalibration:") public boolean shouldDisplayHeadingCalibration(CLLocationManager locationManagerShouldDisplayHeadingCalibration) { throw new UnsupportedOperationException(); }
	...
	static class Callbacks {
		...
		@Callback @BindSelector("locationManagerDidPauseLocationUpdates:") public static void didPauseLocationUpdates(CLLocationManagerDelegate __self__, Selector __cmd__, CLLocationManager locationManagerDidPauseLocationUpdates) { __self__.didPauseLocationUpdates( locationManagerDidPauseLocationUpdates); }
		@Callback @BindSelector("locationManagerDidResumeLocationUpdates:") public static void didResumeLocationUpdates(CLLocationManagerDelegate __self__, Selector __cmd__, CLLocationManager locationManagerDidResumeLocationUpdates) { __self__.didResumeLocationUpdates( locationManagerDidResumeLocationUpdates); }
		...
		@Callback @BindSelector("locationManagerShouldDisplayHeadingCalibration:") public static boolean shouldDisplayHeadingCalibration(CLLocationManagerDelegate __self__, Selector __cmd__, CLLocationManager locationManagerShouldDisplayHeadingCalibration) { return __self__.shouldDisplayHeadingCalibration( locationManagerShouldDisplayHeadingCalibration); }
